...
public class AcrescimoProteinaExtraTest {
  ...
  private AcrescimoCroutons decorator;
  ...
  void testGetPrecoTotal() {
    ...
    assertEquals(
        pedidoBase.getPrecoTotal() + Acrescimo.CROUTONS.getPreco(),
        precoTotal,
        "Testando se o preço total está correto após o acréscimo de croutons");
  }
