...
public class AcrescimoProteinaExtraTest {
  ...
  void setUp() {
    ...
    decorator = new AcrescimoProteinaExtra(pedidoBase);
  }
  ...
  void testExibirDetalhes() {
    ...
    assertEquals(
        "Pedido Pequeno com proteina: BOI com acréscimo de proteína extra.",
        detalhes,
        "Testando se o acréscimo de proteína extra foi aplicado corretamente.");
  }
  ...
  void testGetPrecoTotal() {
    ...
    assertEquals(
        pedidoBase.getPrecoTotal() + 4.00,
        precoTotal,
        "Testando se o preço total é o mesmo do pedido base mais o acréscimo de proteína extra.");
  }
